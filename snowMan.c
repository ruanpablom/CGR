...
float deltaMove = 0.0, zMove = 0.0; // initially camera doesn't move
...
{
	switch (key) {
		case GLUT_KEY_PAGE_UP : deltaMove = 1.0; break;
		case GLUT_KEY_PAGE_DOWN : deltaMove = -1.0; break;	
		case GLUT_KEY_UP : zMove = 0.01; break;
		case GLUT_KEY_DOWN : zMove = -0.01; break;	
	}
} 
...
{
	switch (key) {
		case GLUT_KEY_PAGE_UP : deltaMove = 0.0; break;
		case GLUT_KEY_PAGE_DOWN : deltaMove = 0.0; break;
		case GLUT_KEY_UP :  zMove = 0.0 ;break;
		case GLUT_KEY_DOWN :  zMove = 0.0;break;
	}
} 
